...
void main() {
  // var student0 = Student();            //student0 is reference variable
  // student0.id = 25;
  // student0.name = "Philip";
  // print("${student0.id} and ${student0.name}");

  var student1 = Student(23, "Peter"); 		//student1 is reference variable
  print("${student1.id} and ${student1.name}");

  student1.study();
  student1.sleep();

  var student2 = Student(45, "Sam");		//student2 is reference variable
  ...
  var student3 = Student.myCustomConstructor();//student3 is a reference variable
  student3.id = 54;
  student3.name = "Rahul";
